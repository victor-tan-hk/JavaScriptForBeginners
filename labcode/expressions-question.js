...
/* Q3: Declare 2 variables, store any random number into both of them. Then,  create a mathematical expression using any operator involving these two variables and store the result 
into a new variable. */
